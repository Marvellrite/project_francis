...
import react, { useState, FormEvent, createContext, FC, useContext} from "react";
    ...
    <section className="form_section d-flex vh-100 align-items-center">
      <div className="container shadow-sm rounded bg-white position-relative">
        <div className="border border-2 border-prime border-top-0 border-bottom-0 h-100 overflow-y-auto">
            ...
            {!displayTable && <div className="reveal pt-4">
              ...
              <form onSubmit={Submit_form } className="parameters_holder row mx-0 mt-3">
                <div>
...
{displayTable && <ViewResults calculationType={calculationType}></ViewResults>}
...
const ViewResults:FC<viewResultsType> = ({calculationType}) => {
  ...
  if(!context){
    throw new Error('ViewResults must be used inside the Context Provider wrapper')
  }
